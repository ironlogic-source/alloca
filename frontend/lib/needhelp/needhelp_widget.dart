          ...
          children: [
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (_) => EasyDebounce.debounce(
                      ...
                      () async {
                        _model.messageText = _model.textController.text;
                        safeSetState(() {});
                      },
                    ),
                    autofocus: false,
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  _model.apiResulttcq = await SendMessageCall.call(
                  ...
                  if ((_model.apiResulttcq?.succeeded ?? true)) {
                    ...
                    _model.apiResulty81 = await GetMessagesCall.call();

                    FFAppState().allMessages = functions
                        .sortMessages(((_model.apiResulty81?.jsonBody ?? '')
                                .toList()
